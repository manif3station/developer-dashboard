...
is( $version, '4.62', 'repo version bumped at DD-984\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-984 (Layered Env Files POD cross-reference fix)' );
