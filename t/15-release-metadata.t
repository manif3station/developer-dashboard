...
is( $version, '4.54', 'repo version bumped at DD-928\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-928 (Zipper.pm uncoverable-branch annotation fix)' );
