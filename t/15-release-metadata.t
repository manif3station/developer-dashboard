...
is( $version, '4.46', 'repo version bumped at DD-947\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-947 (extract CollectorRunner.pm\'s command-execution cluster into CommandRunner.pm)' );
