...
is( $version, '4.75', 'repo version bumped per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-1017 (bin/d2 compiled-sibling dispatch fix)' );
