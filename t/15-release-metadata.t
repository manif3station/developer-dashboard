...
is( $version, '4.80', 'repo version bumped per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-1019/DD-1011/DD-1023 (landed together to make real CI green: $?-guard sweep fix, stale usage-string regex, missing as assembler in CI)' );
