...
is( $version, '4.79', 'repo version bumped per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-1020 (correction - real compiler-probe fix for linux-i686 cross-compilation, found via a real CI run of v4.78)' );
