...
is( $version, '4.53', 'repo version bumped at DD-953\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-953 (PAX self-compiled vs interpreter benchmark for the data-query CLI family)' );
