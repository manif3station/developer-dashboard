...
is( $version, '4.60', 'repo version bumped at DD-979\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-979 (.env/.env.pl skill include directive and env->include export)' );
