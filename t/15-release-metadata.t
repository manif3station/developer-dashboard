...
is( $version, '4.55', 'repo version bumped at DD-958\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-958 (Platform.pm forced-Windows coverage fix)' );
