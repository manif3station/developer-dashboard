...
is( $version, '4.38', 'repo version bumped at DD-936\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-936 (PaxCache background compile now opt-in, DD_PAX=on)' );
