...
is( $version, '4.52', 'repo version bumped at DD-951\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-951 (per-skill Go module/build cache isolation)' );
