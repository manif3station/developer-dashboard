...
is( $version, '4.47', 'repo version bumped at DD-950\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-950 (exclude nytprof.out from the release tarball)' );
