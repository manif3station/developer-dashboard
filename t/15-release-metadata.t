...
is( $version, '4.48', 'repo version bumped at DD-948\'s distro-column gate per owner instruction 2026-09-16 (version bump now happens per-ticket in the distro column, not only at the epic-level VERSION GATE): DD-948 (dashboard ask CLI-fallback path tees live output instead of buffering)' );
