...
t/107-cpan-security-metadata.t - verify the DD-392 fail-closed CPAN vulnerability policy
...
Run C<prove -lv t/107-cpan-security-metadata.t> while iterating. Then run the
...
Example 1:
  ...
  prove -lv t/107-cpan-security-metadata.t
