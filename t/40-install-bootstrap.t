...

{
    ...
    like( $install_ps_text, qr/\$ddShellBootstrapText\s*=\s*Join-ScriptText\s+-Value\s+\`\$ddShellBootstrap/s, 'install.ps1 normalizes dashboard shell ps output arrays into one profile bootstrap string' );
