...
close $fake_editor_log_fh;
is($fake_editor_args, "$open_target $second_open_target\n", 'dashboard of opens both selected files for comma-separated multi selection');
