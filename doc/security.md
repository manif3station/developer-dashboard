...
- project-local `./.developer-dashboard/config/sql-dashboard` is tightened to `0700` when the SQL workspace uses it, and saved SQL connection profile files there are tightened to `0600`
